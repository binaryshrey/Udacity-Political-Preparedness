...
class ElectionListAdapter(private val clickListener: ElectionListener) : ListAdapter<Election, ElectionListAdapter.ElectionViewHolder>(ElectionElementDiffCallback()) {


    // on-click listener for ElectionListAdapter
...
class ElectionElementDiffCallback : DiffUtil.ItemCallback<Election>() {
